  ...
  return (
    <div className="px-4 md:px-10">
      <div className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
        ...
        <p>
          At Rainbow, we are committed to safeguarding your privacy. This
        ...
        <div className="space-y-2">
          ...
          <p>
            ...
            the data we collect, please contact us at rainbow@p7u.tech.
          </p>
        </div>
        <p>
          By using Rainbow, you agree to the practices outlined in this Privacy
