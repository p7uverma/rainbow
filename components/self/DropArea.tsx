    ...
    return (
      <div className="space-y-6">
        {actions.map((action: Action, i: any) => (
          <div
            key={i}
            className="w-full p-4 cursor-pointer rounded-xl border flex flex-col items-center justify-between"
          >
            {!is_loaded && (
              <Skeleton className="h-full w-full -ml-10 cursor-progress absolute rounded-xl" />
            )}
            <div className="flex gap-4 items-center px-2 pb-6 pt-2">
              <span className="text-2xl text-orange-600">
                {fileToIcon(action.file_type)}
              </span>
              <div className="flex items-center gap-1 w-[60vw]">
            ...
            {!action.is_converted && !action.is_converting && (
              <div className="flex flex-row justify-between w-full">
                ...
                <span
                  ...
                  className="cursor-pointer hover:bg-primary-foreground rounded-full h-10 w-10 flex items-center justify-center text-2xl text-gray-400"
                >
                  <MdClose />
                </span>
              </div>
